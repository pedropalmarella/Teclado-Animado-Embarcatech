...
int main()
{
    ...
    while (true) 
    {
        ...
        case '4':
            // Função para mostrar animação quando a tecla '4' for pressionada
            setar_leds_azul(tecla4_frame1, valor_led, pio, sm, r, g, b);
            sleep_ms(500);
            setar_leds_azul(tecla4_frame2, valor_led, pio, sm, r, g, b);
            sleep_ms(500);
            setar_leds_verde(tecla4_frame3, valor_led, pio, sm, r, g, b);
            sleep_ms(500);
            setar_leds_vermelho(tecla4_frame4, valor_led, pio, sm, r, g, b);
            sleep_ms(500);
            setar_leds_verde(tecla4_frame5, valor_led, pio, sm, r, g, b);
            sleep_ms(500);
            setar_leds_azul(tecla4_frame6, valor_led, pio, sm, r, g, b);
            sleep_ms(500);
            break;
